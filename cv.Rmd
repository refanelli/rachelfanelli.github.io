...
<p>&nbsp;</p>  
### **EDUCATION**
#### **PhD in Ecology and Evolution** (Current PhD Student)
##### University of Wyoming, Laramie, Wyoming, USA
##### Advised by  <a href="https://thebedfordlab.com/">Dr. Nicole Bedford</a>
#### **Master of Science in Biology** (2021)                
##### Queen's University, Kingston, Ontario, Canada 
##### Advised by Drs. <a href="https://www.bonierlab.com/">Fran Bonier</a> and <a href="https://www.paulmartinlab.com/">Paul Martin </a>        
...
<p>&nbsp;</p>
### **PUBLICATIONS**
##### Stanton, L.A., Cooley, C.A., Davis, E.C., **Fanelli, R.E.**, Benson-Amram, S. 2024. Wild raccoons demonstrate flexibility and individuality in innovative problem solving. *Proceedings of the Royal Society B: Biological Sciences* 291, 20240911.
##### Petrenko, J.A., Martin P.R., **Fanelli R.E.**, Bonier F. 2024. Urban tolerance does not protect against population decline in North American birds. *Biology Letters* 20.1.
##### **Fanelli, R.E.**, P.R. Martin, O.J. Robinson, and F. Bonier. 2022. Estimates of species-level tolerance of urban habitat in North American birds. *Ecology* e3821. https://doi.org/10.1002/ecy.3821.
...
##### **Fanelli, R.E.**, E. Quallen, M. Ben-David, N. Bedford. Hippocampal neuroanatomy and spatial memory pre-and post-torpor in the Least Chipmunk (*Neotamias minimus*). Animal Behavior Society Conference. Portland, Oregon. 2023. *Poster Presentation*
...
- ##### Conducted nest searches for ground-nesting and shrub-nesting species, monitored nests until birds fledged, and conducted vegetation surveys at bird capture sites 
...
- ##### Used centrifuges to separate plasma from whole blood, prepared slides using whole blood smears, measured total plasma protein using a digital refractometer, and ensured samples were properly prepared for long-term storage 
- ##### Tracked VHF radio-collared raccoons 
- ##### Operated RFID data loggers and maintained trail cameras to monitor wildlife activity 
- ##### Wrote applications and applied for university and state research permits and obtained permission from property owners to collect data on private property  
...
##### Oct 2017 - Mar 2018
- ##### Processed hunter-harvested ungulate tissue samples (lymph node and obex) using scales and ribolyzers before using an ELISA (enzyme-linked immunosorbent analysis) to test samples for the presence of chronic wasting disease (CWD) prion proteins 
- ##### Reported results from ELISA tests to a state database where hunters could check the results from their samples and to provide the public with an updated map of CWD cases across the state
- ##### Used mapping software to assign coordinate data to every harvested sample that was processed for CWD before uploading test results to the state's database
- ##### Assisted with wildlife captures of large ungulates and collected and prepared biological samples from animals for state-wide health surveys
...
- ##### Processed blood samples using centrifuges to separate plasma from whole blood for downstream brucellosis testing
- ##### Followed standard operating procedures for running a variety of assays and to safely work in a BSL-2 lab
...
##### Jun 2014 -Jun 2016
- ##### Assessed the problem-solving abilities, learning, and behavioral flexibility of raccoons by presenting individuals with a novel foraging devise (i.e., puzzle box) in captivity
...
### **TEACHING EXPERIENCE**
##### **Teaching Assistant for Evolutionary Medicine** (Winter 2021 Term)
...
##### **Teaching Assistant for Animal Behaviour** (Summer 2021 Term)
- ##### Assisted students design independent animal behavior research projects and marked student projects 
  
##### **Teaching Assistant for Ecology** (Fall 2019 and 2020 Terms)
...
##### **Teaching Assistant for Fundamental of Biology** (Winter 2020 Term)
- ##### Monitored course email and responded to student questions; acted as the point person between course instructors and students and ensured instructors were aware of student questions and feedback in a timely manner 
  
##### **Principles of Animal Behavior** (Spring 2017 semester)
- ##### Invited guest speaker for a lecture on social learning in animal.  
  
##### **Urbanization and Biodiversity** (Winter 2022 semester)
- ##### Invited guest speaker for a lecture on methods for quantifying species responses to urban habitat. 
  
##### **Mentor for Undergrad Thesis Student** (Fall 2021-Winter 2022)
...
- ##### Held weekly meetings with an undergraduate student to review material presented in class lectures and develop effective study habits to succeed in the course
  
##### **Undergraduate Teaching Assistant** (Spring 2015 semester)
##### Animal Biology at University of Wyoming
- ##### Assisted a graduate student TA prepare experiments for weekly lab sections for a semester-long undergraduate animal biology course
- ##### Attended lab sections, weekly lab prep meetings, and assisted students and answered questions during labs
